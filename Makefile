...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/16 16:14:07 by oldurosi          #+#    #+#              #
#    Updated: 2019/10/15 22:34:47 by oldurosi         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= ft_memset.c ft_bzero.c	\
		  ...
		  ft_lstfold.c ft_nbrlen.c ft_wordcount.c \
		  ft_wordlen.c ft_iswspace.c ft_isspace.c
